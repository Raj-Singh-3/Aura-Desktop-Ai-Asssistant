...
function App() {
  ...
  return (
    <div className="relative flex h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      {/* Logout Button */}
      <button
        onClick={handleLogout}
        className="absolute top-4 right-4 px-3 py-1 text-sm bg-red-600 hover:bg-red-700 text-white rounded-md z-50"
        title="Logout"
      >
        Logout
      </button>
